const cameraImage = document.getElementById("faceImage"); // ! Note: this image should be one from the webcam.
...
Promise.all([
    faceapi.nets.faceRecognitionNet.loadFromUrl("../models"),   // ? Main API for the recognition
    faceapi.nets.faceLandmark68Net.loadFromUrl("../models"),    // ? This API locates the faces
    faceapi.nets.ssdMobilenetv1.loadFromUrl("../models"),       // ? This API is the recognition for faces
]).then(start)
